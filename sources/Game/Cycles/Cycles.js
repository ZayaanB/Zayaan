...
export class Cycles
{
    constructor(name = 'Cycles', duration = 10, forcedProgress = null, manual = false)
    {
        ...
        this.absoluteProgress = this.forcedProgress !== null ? this.forcedProgress : (Date.now() / 1000 / this.duration)
        ...
        this.newAbsoluteProgressBinding = this.game.debug.addManualBinding(
            ...
            () =>
            {
                return this.forcedProgress !== null ? this.forcedProgress : ((new Date()).getTime() / 1000 / this.duration)
            },
            manual
        )
