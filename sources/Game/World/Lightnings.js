...
const STORAGE_KEY = 'stormsEnabled'
...
export class Lightnings
{
    constructor()
    {
        ...
        this.frequency = 2
        this.hitChances = 0
        this.enabled = this.readPersisted() // Storms can be disabled from the options menu
    ...
    update()
    {
        // Storms disabled: skip all lightning checks entirely
        if(!this.enabled)
            return
