...
`;e.s(["GlowCard",0,({children:e,className:n="",glowColor:o="green",size:l="md",width:d,height:c,customSize:p=!1})=>{let h=(0,r.useRef)(null);(0,r.useEffect)(()=>{let e=h.current;if(!e)return;let a=a=>{let r=e.getBoundingClientRect(),t=a.clientX-r.left,i=a.clientY-r.top;e.style.setProperty("--x",t.toFixed(2)),e.style.setProperty("--y",i.toFixed(2)),e.style.setProperty("--xp",(a.clientX/window.innerWidth).toFixed(2)),e.style.setProperty("--yp",(a.clientY/window.innerHeight).toFixed(2))};return document.addEventListener("pointermove",a),()=>document.removeEventListener("pointermove",a)},[]);let{base:g,spread:u}=t[o],m={"--base":g,"--spread":u,"--radius":"14","--border":"2","--backdrop":"rgba(15, 18, 35, 0.85)","--backup-border":"rgba(0, 255, 136, 0.18)","--border-light-opacity":"0.12","--size":"240","--outer":"1","--border-size":"calc(var(--border, 2) * 1px)","--spotlight-size":"calc(var(--size, 150) * 1px)","--hue":"calc(var(--base) + (var(--xp, 0) * var(--spread, 0)))",backgroundImage:`radial-gradient(
      var(--spotlight-size) var(--spotlight-size) at
      calc(var(--x, 50%) * 1px)
      calc(var(--y, 50%) * 1px),
      hsl(var(--hue, 152) calc(var(--saturation, 100) * 1%) calc(var(--lightness, 70) * 1%) / var(--bg-spot-opacity, 0.08)), transparent
    )`,backgroundColor:"var(--backdrop, transparent)",backgroundSize:"calc(100% + (2 * var(--border-size))) calc(100% + (2 * var(--border-size)))",backgroundPosition:"50% 50%",border:"var(--border-size) solid var(--backup-border)",position:"relative",touchAction:"none",...void 0!==d?{width:"number"==typeof d?`${d}px`:d}:{},...void 0!==c?{height:"number"==typeof c?`${c}px`:c}:{}},b=p?"":i[l];return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)("style",{dangerouslySetInnerHTML:{__html:s}}),(0,a.jsxs)("div",{ref:h,"data-glow":!0,style:m,className:`
          ${b}
          rounded-2xl
          relative
